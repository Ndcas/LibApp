                ...
                <View style={{ flex: 3, flexDirection: "row", gap: 15 }}>
                    ...
                    <View style={styles.topLeftBox}>
                        <View style={{ flex: 3, justifyContent: "center" }}>
                            <Text style={styles.userName}>{global.user.hoTen}</Text>
                        </View>
                    </View>
                </View>
                <View style={styles.bottomBox}>
                    <View style={styles.bottomLeft}>
                        <Text style={styles.bottomLeftText}>Mã độc giả</Text>
                        <Text style={styles.bottomLeftText}>{global.user.maDocGia}</Text>
                    </View>

                    <View style={styles.bottomRight}>
                        <Text style={styles.bottomRightText}>Độc giả</Text>
                    </View>
                </View>
            </View>
